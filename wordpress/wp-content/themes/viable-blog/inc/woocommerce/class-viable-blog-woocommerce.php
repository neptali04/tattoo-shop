<?php
/**
 * Viable Blog class and the class object initialization.
 *
 * @package    Viable_Blog_Pro
 * @author     Themebeez <themebeez@gmail.com>
 * @copyright  Copyright (c) 2018, Themebeez
 * @link       http://themebeez.com/themes/viable-blog/
 * @license    http://www.gnu.org/licenses/old-licenses/gpl-2.0.html
 */

/**
 * Viable Blog Woocommerce Class
 */
class Viable_Blog_Woocommerce {
	...
	public function enqueue_scripts() {
		wp_enqueue_style( 'viable-blog-woocommerce-style', get_template_directory_uri() . '/woocommerce.css' );
		...
		wp_add_inline_style( 'viable-blog-woocommerce-style', $inline_font );
	}
